          ...
          <Card>
            ...
            <CardContent className="p-2">
              <div className="h-32 relative">
                <EmotionPieChart data={emotionFrequency.slice(0, 5)} />
              </div>
            </CardContent>
          </Card>

          {/* Emotion Average Intensity - Summary */}
          <Card>
            <CardHeader className="pb-1">
              <CardTitle className="text-sm">Emotion Intensity</CardTitle>
            </CardHeader>
            <CardContent className="p-2">
              <div className="h-32 relative">
                <EmotionBarChart data={emotionIntensity.slice(0, 5)} />
              </div>
            </CardContent>
          </Card>

          {/* Emotion Trends - Summary */}
          <Card>
            <CardHeader className="pb-1">
            ...
            <CardContent className="p-2">
              <div className="h-32 relative">
                <EmotionTrendsChart data={emotionJourney.slice(0, 5)} />
              </div>
            </CardContent>
          </Card>
        </div>
